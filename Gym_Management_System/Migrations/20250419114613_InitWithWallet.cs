    ...
    public partial class InitWithWallet : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 44, true, "Recovery Room" },
                    { 2, 1, 21, true, "Mobility Area" },
                    { 3, 1, 35, true, "Endurance Zone" },
                    { 4, 1, 32, true, "Functional Room" },
                    { 5, 1, 47, true, "Dance Studio" },
                    { 6, 2, 40, true, "Endurance Zone" },
                    { 7, 2, 30, true, "Spin Studio" },
                    { 8, 2, 40, true, "Cardio Room" },
                    { 9, 2, 49, true, "Dance Studio" },
                    { 10, 2, 33, true, "Strength Studio" },
